...
- **files**: `lib/Settings/planninq_register.json`
- **acceptance_criteria**:
...
- **files**: `lib/Settings/planninq_register.json`, `appinfo/info.xml`
- **acceptance_criteria**:
...
- **acceptance_criteria**:
  ...
  - GIVEN the six-schema drift test WHEN run THEN `PlanninqRegisterSchemaTest` still passes (no schema added or removed; count stays exactly six)
- [x] Implement
- [x] Test
