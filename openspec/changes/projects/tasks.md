...
- [ ] 3.1 **Create `src/views/ProjectList.vue` — layout and data binding**
...
- [ ] 3.3 **Add search filter (client-side, debounced 300 ms)**
...
- [ ] 3.4 **Add status filter chips (`Active`, `Archived`, `Completed`)**
...
- [ ] 5.1 **Create `src/views/ProjectBoard.vue` — board shell**
...
- [ ] 5.3 **Create `src/views/ProjectBacklog.vue` — backlog placeholder**
...
- [ ] 7.2 **Implement cascade delete in store (task 2.8)**
...
- [ ] 11.8 **Verify WCAG AA compliance for new components**
