...
**Scope**: planix
**OpenSpec changes**:
- [register-schemas](../../) — defines all 5 schemas and seed data in `planix_register.json`

## Purpose

Defines the OpenRegister schema declarations and seed data that form the Planix data model. This is the foundational capability — every other Planix feature depends on these schemas being correctly declared and importable. The change removes the placeholder `example` schema and replaces it with the five production schemas: `task`, `project`, `column`, `timeEntry`, and `label`.

---

## ADDED Requirements

### Requirement: REQ-RSC-001 — All 5 schemas defined [MVP]
...
### Requirement: REQ-RSC-002 — Schema validation enforced by OpenRegister [MVP]
...
### Requirement: REQ-RSC-003 — Seed data loaded on install [MVP]
...
### Requirement: REQ-RSC-004 — Idempotent import [MVP]
...
### Requirement: REQ-RSC-005 — Version-based skip logic [MVP]
