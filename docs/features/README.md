...
|---------|---------|-----------|-----|
| Register Schemas | 6 schemas (task, project, column, timeEntry, label, dependency) with seed data for project management | OpenRegister v0.2.10+ | [register-schemas.md](register-schemas.md) |
...
| Tasks | Task lifecycle management: CRUD, priorities, labels, assignees, due dates, dependencies, status workflow | iCalendar VTODO (RFC 5545), Schema.org Action/PlanAction, VNG InterneTaak | [tasks.md](tasks.md) |
