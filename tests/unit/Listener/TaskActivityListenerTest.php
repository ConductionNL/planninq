...
class TaskActivityListenerTest extends TestCase
{
    ...
    private function makeListener(
        ...
        $registerMapper = new class($registerEntity) {
            ...
            public function find($id): object { return $this->e; }
        };
        ...
        $objectService = new class($project) {
            ...
            public function setRegister($r): self { return $this; }
            public function setSchema($s): self { return $this; }
            public function find($id): array { return $this->project; }
        };
    ...
    private function taskEntity(?array $data, string $register = '1', string $schema = '2'): ObjectEntity
    {
        ...
        return new class($data ?? [], $register, $schema) extends ObjectEntity {
            // phpcs:disable
            public function __construct(private array $d, private string $reg, private string $sch) {}
            public function getObject(): array { return $this->d; }
            public function getRegister(): ?string { return $this->reg; }
            public function getSchema(): ?string { return $this->sch; }
            public function getUuid(): ?string { return 'task-uuid-1'; }
            // phpcs:enable
        };
    }//end taskEntity()
    ...
    private function makeListenerWithFailingProjectLookup(string $actor): TaskActivityListener
    {
        ...
        $registerEntity = new class { public function getSlug(): string { return 'planix'; } };
        $schemaEntity   = new class { public function getSlug(): string { return 'task'; } };
        $registerMapper = new class($registerEntity) {
            public function __construct(private object $e) {}
            public function find($id): object { return $this->e; }
        };
        ...
        $objectService = new class {
            public function setRegister($r): self { return $this; }
            public function setSchema($s): self { return $this; }
            public function find($id): array { throw new \RuntimeException('not found'); }
        };
